WITH source_data AS (
    SELECT
        ...
        , {{ literal_name("stg_icu_organization.legal_name") }}             AS icu_literal_name
        , {{ word_tags("stg_icu_organization.legal_name") }}                AS word_tags
        , {{ literal_name("stg_icu_organization.tax_number") }}             AS icu_tax_number_literal
...
SELECT
    ...
    , source_data.icu_tax_number_literal
FROM source_data
LEFT JOIN address
